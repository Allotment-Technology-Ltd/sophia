...
#   NEON_AUTH_BASE_URL
#   RESTORMEL_GATEWAY_KEY, RESTORMEL_ENVIRONMENT_ID, RESTORMEL_KEYS_BASE
#   (RESTORMEL_PROJECT_ID + RESTORMEL_BASE_URL come from Secret Manager --set-secrets)
...
#
# Step F (Fireworks extraction): same Secret Manager bindings as deploy-sophia-ingest-worker-service.sh —
#   EXTRACTION_BASE_URL, EXTRACTION_MODEL, FIREWORKS_API_KEY (plus secretAccessor on JOB_SA).
#
set -euo pipefail
...
# Set explicitly for your environment; do not commit real email lists.

...
exports.staticIpAddress = exports.nightlySchedulerServiceAccountEmail = exports.ingestServiceAccountEmail = exports.appServiceAccountEmail = exports.registryLocation = exports.vpcConnectorId = exports.nightlySchedulerJobName = exports.nightlyIngestJobName = exports.ingestImagePath = exports.appImagePath = exports.appServiceRegion = exports.appServiceName = exports.appServiceUrl = void 0;
    ...
    template: {
        ...
        containers: [{
                ...
                envs: [
                    ...
                    {
                        name: "OWNER_UIDS",
                        valueSource: { secretKeyRef: { secret: "owner_uids", version: "latest" } },
                    },
                ],
            }],
    },
...
// ─── Outputs ──────────────────────────────────────────────────────────────────
exports.appServiceUrl = appService.uri;
exports.appServiceName = appService.name;
exports.appServiceRegion = appService.location;
exports.appImagePath = pulumi.interpolate `${region}-docker.pkg.dev/${projectId}/sophia/app`;
exports.ingestImagePath = pulumi.interpolate `${region}-docker.pkg.dev/${projectId}/sophia/sophia-ingest`;
exports.nightlyIngestJobName = nightlyIngestJob.name;
exports.nightlySchedulerJobName = nightlySchedulerJob.name;
exports.vpcConnectorId = vpcConnector.id;
exports.registryLocation = registry.location;
exports.appServiceAccountEmail = appSa.email;
exports.ingestServiceAccountEmail = ingestSa.email;
exports.nightlySchedulerServiceAccountEmail = nightlySchedulerSa.email;
exports.staticIpAddress = lbIp.address;

...
function normalizeRelationType(value: unknown): unknown {
	...
	const relationMap: Record<string, (typeof RELATION_TYPE_VALUES)[number]> = {
		...
		refute: 'contradicts',
		rebuts: 'contradicts',
		rebuts_claim: 'contradicts',
		disputes: 'contradicts',
		opposes: 'contradicts',
		challenges: 'contradicts',
		objects_to: 'contradicts',
		object_to: 'contradicts',
		depends_on: 'depends_on',
		depends: 'depends_on',
		depends_upon: 'depends_on',
		requires: 'depends_on',
		presupposes: 'depends_on',
		assumes: 'depends_on',
		based_on: 'depends_on',
		responds_to: 'responds_to',
		responds: 'responds_to',
		responds_directly_to: 'responds_to',
		replies_to: 'responds_to',
		reply_to: 'responds_to',
		answers: 'responds_to',
		addresses: 'responds_to',
		counters: 'responds_to',
		defines: 'defines',
		define: 'defines',
		definition_of: 'defines',
		defines_term: 'defines',
		means: 'defines',
		specifies: 'defines',
		qualifies: 'qualifies',
		qualify: 'qualifies',
